          ...
          <div className="relative" ref={knowledgeBasePanelRef}>
            ...
            >
              ...
              {selectedKnowledgeBaseIds.length > 0 && (
                <span className="text-[11px] px-1.5 py-0.5 rounded-full bg-gray-300 dark:bg-gray-600 text-gray-700 dark:text-gray-200">
                  ...
                  {!isKnowledgeBaseLoading && knowledgeBaseError && (
                    <div className="text-xs text-red-400 px-2 py-3">
                      ...
                      <button
                        ...
                        className="mt-2 text-xs text-gray-400 hover:text-foreground transition-colors"
                      >
                        重新加载
                      </button>
                    </div>
                    ...
                    knowledgeBases.map((kb) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {isSelected && (
                            <span className="text-[11px] px-2 py-0.5 rounded-full bg-gray-300 dark:bg-gray-600 text-gray-700 dark:text-gray-200">
                              已选
                            </span>
                          )}
                        </button>
